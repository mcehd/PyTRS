...
#        pass
    ...
    # Initialise the map.
    map_len = 10 # meters
    map_ppm = 10 # map_points_per_meters = 1
    ...
    map_arr = np.zeros((4*array_side_len+1, 4*array_side_len+1), dtype="uint8")
    ...
    while True:
        ...
        if plot_data:
            ...
            sensor_ax.clear()
            sensor_ax.plot(*rel2abs(x[inside], y[inside], youbot_pos, youbot_euler[2]), '.g')
            ...
            sensor_ax.plot(*rel2abs(pts[0, contacts], pts[1, contacts], youbot_pos, youbot_euler[2]), '*m')
